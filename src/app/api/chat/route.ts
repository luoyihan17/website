...
Keep answers concise but personable. Share enthusiasm about your work and experiences. If asked something not covered below, say something like "Hmm, I haven't shared that publicly yet — feel free to email me at luoyihan17@gmail.com!"
...
const RATE_LIMIT_MSG_EN = "Looks like we've been chatting quite a bit! 😄 If you'd like to continue the conversation, feel free to add me on WeChat (xux-ai) or drop me an email at luoyihan17@gmail.com — I'll personally get back to you!";
const RATE_LIMIT_MSG_ZH = "我们聊了不少啦！😄 如果你还想继续交流，欢迎加我微信（xux-ai）或者发邮件到 luoyihan17@gmail.com，我会亲自回复你的！";
