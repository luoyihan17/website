...
When I first joined QQ Music, I kept thinking about one question: QQ Music owns a large library of high-quality global music rights. Beyond listening, what new value could this content create?
...
Users could still listen to foreign songs they liked. During playback, they could understand lyrics, learn expressions, and remember them through repeated listening.

For me, the value was not to "make a learning feature." It was to keep users who learn through foreign songs inside QQ Music's listening flow.

I first pitched the idea during my conversion review. I designed the first concept myself, using QQ Music's existing player habits and nearby live entry points as references.
...
After the review, I reached out to the product team to push it toward a real feature.
...
I kept refining the proposal. I added a learning page in QQ Music's music hall to collect curated foreign-language songs.
...
Users could tap into player mode, mark difficult words, and save them. Exam-focused learners could also start from dictionary categories, pick related songs, and use them to reinforce memory.
...
Once we discussed the collaboration with Duolingo, two constraints became clear:
...
<section class="foreign-learning-constraints">
  ...
  <p><strong>Limited resources.</strong> The standalone player could technically ship on its own. But it had to compete with higher-priority work, so it did not get enough development priority.</p>
</section>
...
At this point, I stopped pushing the full language-learning player. We broke the idea down again. If we could only build a small part, what value had to stay?

The answer was not the player.
**It was helping users meet and learn a foreign language in a lighter, more playful way inside music.**
...
The Duolingo collaboration also moved forward. Duo, the Duolingo mascot, joined our musician page as a "music artist" and released a new song. Duo also appeared as a companion character for language learners inside QQ Music.
...
I started by wanting to push a player. What actually shipped was only a small point inside the product.

But through it, I experienced the full path: **Find opportunity → Propose idea → Design solution → Push product → Face constraints → Reduce scope → Find a new landing point.**
